...
const data = [
  {
    type: 'Humlan P',
    imageUri: require('../../assets/svg/urbanears_blue.png'),
  ...
  {
    type: 'Pampas',
    imageUri: require('../../assets/svg/urbanears_pink.png'),
  ...
  {
    type: 'Humlan P',
    imageUri: require('../../assets/svg/urbanears_grey.png'),
  ...
  {
    type: 'Humlan B',
    imageUri: require('../../assets/svg/urbanears_mint.png'),
    heading: 'From Sweden',
    description:
...
export default function HeadphonesCarousel() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        style={styles.logo}
        source={require('../../assets/svg/ue_black_logo.png')}
      />
      <Pagination
        scrollOffsetAnimatedValue={scrollOffsetAnimatedValue}
        positionAnimatedValue={positionAnimatedValue}
